            ...
            <div class="container px-6 py-12 mx-auto">
                <div class="lg:flex lg:items-center lg:-mx-6">
                    <div class="lg:w-1/2 lg:mx-6 ">
                        ...
                        <h1 class="mb-6 text-4xl font-bold leading-none tracking-normal text-gray-900 md:text-4xl md:tracking-tight">
                        <span class="block w-full py-22 text-transparent bg-clip-text leading-12 bg-gradient-to-r from-blue-600 to-green-400 lg:inline">Contact us for more info</span> <span></span>
                    </h1>
                        ...
                        <div class="mt-6 space-y-8 md:mt-8">
                            <p class="flex items-start -mx-2">
                                ...
                                <span class="mx-2 text-gray-700 truncate w-72 dark:text-gray-400">
                                    InfiniteWalletPayTeam  @
                                    <a href="#"> https://infinite.com</a>
                                </span>
                            </p>
                            ...
                            <p class="flex items-start -mx-2">
                                ...
                                <span class="mx-2 text-gray-700 truncate w-72 dark:text-gray-400"><a href="#">Infinitewalletteam@gmail.com</a></span>
                            </p>
                        </div>
                        ...
                        <div
                            ...
                            <form class="mt-6">
                                ...
                                <div class="w-full mt-6">
                                    ...
                                    <textarea class="block w-full h-27 px-5 py-3 mt-2 text-gray-700 placeholder-gray-400 bg-white border border-gray-200 rounded-md md:h-48 dark:placeholder-gray-600 dark:bg-gray-900 dark:text-gray-300 dark:border-gray-700 focus:border-blue-400 dark:focus:border-blue-400 focus:ring-blue-400 focus:outline-none focus:ring focus:ring-opacity-40" placeholder="Write your message here"></textarea>
                                </div>
